      ...
      <div className="bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg">
        ...
        <div className="flex flex-wrap justify-between gap-2">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded text-white bg-gray-700 text-sm disabled:opacity-70 
            cursor-pointer">
            Cancel
          </button>
          ...
          <button
            ...
            className="px-5 py-2.5 rounded bg-[#5eeccc] text-black hover:bg-[#1be4b5] text-sm">
            Crop & Upload
          </button>
        </div>
      </div>
